...
export class CertificationService implements ICertificationService {
  ...
  private _validateAndCleanCertificationData(data: CreateCertificationRequest): CreateCertificationRequest {
  ...
  private async _checkDuplicateCertification(userId: string, data: CreateCertificationRequest): Promise<void> {
  ...
  async addCertification(userId: string, certificationData: CreateCertificationRequest): Promise<Certification> {
    ...
    const validatedData = this._validateAndCleanCertificationData(certificationData);
    await this._checkDuplicateCertification(userId, validatedData);
