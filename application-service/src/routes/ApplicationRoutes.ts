...
router.post('/apply',(req: AuthRequest, res) => applicationController.applyForJob(req, res));
router.get('/user/applications',(req: AuthRequest, res) => applicationController.getUserApplications(req, res));
router.get('/check-status/:jobId',(req: AuthRequest, res) => applicationController.checkApplicationStatus(req, res));
...
router.get('/company/statistics',(req: AuthRequest, res) => applicationController.getCompanyApplicationStats(req, res));
router.patch('/bulk/status',(req: AuthRequest, res) => applicationController.bulkUpdateApplicationStatus(req, res));
