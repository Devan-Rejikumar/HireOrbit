...
const UserOffersPage = lazy(() => import('./pages/UserOffersPage'));
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        <Route path={ROUTES.COMPANY_OFFERS} element={<CompanyProtectedRoute><Suspense fallback={<LoadingFallback />}><CompanyOffersPage /></Suspense></CompanyProtectedRoute>} />
