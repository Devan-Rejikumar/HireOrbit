...
export interface IApplicationService {
  applyForJob(data: CreateApplicationInput, resumeBuffer?: Buffer, resumeMimeType?: string): Promise<ApplicationResponse>;
  ...
  getCompanyApplications(companyId: string, atsScoreMin?: number): Promise<CompanyApplicationsResponse>;
