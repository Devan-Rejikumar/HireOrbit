...
router.post('/upload-url', asyncHandler((req: Request, res) => offerController.generateUploadUrl(req, res)));
router.post('/:offerId/attach-pdf', asyncHandler((req: Request, res) => offerController.attachOfferPdf(req, res)));
