...
export interface IApplicationRepository {
  ...
  findByCompanyIdWithRelations(companyId: string, atsScoreMin?: number): Promise<Array<Application & {statusHistory: ApplicationStatusHistory[];notes: ApplicationNotes[];}>>;
